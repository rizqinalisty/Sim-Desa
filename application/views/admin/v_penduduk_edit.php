      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            <li class="breadcrumb-item text-sm"><a class="opacity-5 text-dark" href="javascript:;">Data Penduduk</a></li>
          </ol>
          <h6 class="font-weight-bolder mb-0">Desa Kita Jaya</h6>
        </nav>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td class="align-middle">
                       <a href="<?php echo base_url('Data_Penduduk/penduduk_edit/'.$b->nik);?>" class="btn btn-sm btn-success"><i class="fa fa-wrench"></i> Edit</a>  
						<a href="<?php echo base_url('Data_Penduduk/penduduk_hapus/'.$b->nik); ?>" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i> Hapus</a> 
                      </td>
                    </tr>
